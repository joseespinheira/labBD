...
require_once("DAO/MigrationsCriteriaDAO.php");

/**
 * The MigrationsCriteria class extends MigrationsDAOCriteria and is used
 ...
 * @version 1.0
 */
class MigrationsCriteria extends MigrationsCriteriaDAO
{
