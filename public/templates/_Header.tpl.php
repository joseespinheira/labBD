...
<!--html lang="en">
	<head>
		...
		<meta name="description" content="C9" />
			...
			<div class="navbar navbar-inverse navbar-fixed-top">
				<div class="navbar-inner">
					<div class="container">
						...
						<a class="brand" href="./">C9</a>
						<div class="nav-collapse collapse">
							<ul class="nav">
								<li <?php if ($this->nav=='migrationses') { echo 'class="active"'; } ?>><a href="./migrationses">Migrationses</a></li>
								<li <?php if ($this->nav=='userses') { echo 'class="active"'; } ?>><a href="./userses">Userses</a></li>
								</ul>
								</li>
							</ul>
