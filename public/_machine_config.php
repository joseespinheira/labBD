...
GlobalConfig::$CONNECTION_SETTING->DBName = "c9";
...
/** the root url of the application with trailing slash, for example http://localhost/c9/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'c9/';
