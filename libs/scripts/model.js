/**
 * backbone model definitions for C9
 */
...
/**
 * Notasdasprovas Backbone Model
 */
model.NotasdasprovasModel = Backbone.Model.extend({
	urlRoot: 'api/notasdasprovas',
...
/**
 * Notasdasprovas Backbone Collection
 */
model.NotasdasprovasCollection = model.AbstractCollection.extend({
	url: 'api/notasdasprovases',
	model: model.NotasdasprovasModel
});

/**
 * Migrations Backbone Model
 */
model.MigrationsModel = Backbone.Model.extend({
	urlRoot: 'api/migrations',
	idAttribute: 'id',
	id: '',
	migration: '',
	batch: '',
...
/**
 * Migrations Backbone Collection
 */
model.MigrationsCollection = model.AbstractCollection.extend({
	url: 'api/migrationses',
	model: model.MigrationsModel
});
