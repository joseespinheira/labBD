<div class="form-group {{ $errors->has('id_disciplina') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="id_disciplina" type="number" id="id_disciplina" value="{{ $monitora->id_disciplina or ''}}" required>
...
<div class="form-group {{ $errors->has('id_curso') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="id_curso" type="number" id="id_curso" value="{{ $monitora->id_curso or ''}}" required>
...
<div class="form-group {{ $errors->has('ano_semestre') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="ano_semestre" type="text" id="ano_semestre" value="{{ $monitora->ano_semestre or ''}}" required>
...
<div class="form-group {{ $errors->has('matricula_aluno') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="matricula_aluno" type="number" id="matricula_aluno" value="{{ $monitora->matricula_aluno or ''}}" required>
...
<div class="form-group {{ $errors->has('matricula_professor') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="matricula_professor" type="number" id="matricula_professor" value="{{ $monitora->matricula_professor or ''}}" required>
